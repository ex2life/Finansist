...
//---------------------------------------------------------------------
function Platezh_to_html($type_platezh, $str_beg_date, $sum_kred, $col_month, $proc, $arr_all_platezh) 
{
	# TODO: Для всех сумм указывать два знака после запятой + отделять разряды(?)
